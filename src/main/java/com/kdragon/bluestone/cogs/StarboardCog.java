...
import com.kdragon.bluestone.Emotes;
...
import com.kdragon.bluestone.sql.Starboard;
import com.kdragon.bluestone.sql.StarboardEntry;
import com.kdragon.bluestone.sql.Starrer;
import com.kdragon.bluestone.util.GraphicsUtils;
...
public class StarboardCog extends Cog {
    ...
    private void cmdCreate(Context ctx) throws SQLException {
        com.kdragon.bluestone.Command.checkPerms(ctx, MOD_PERMS);
