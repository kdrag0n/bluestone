...
import com.kdragon.bluestone.Permissions;
import com.kdragon.bluestone.annotations.Command;
import com.kdragon.bluestone.errors.PermissionError;
import com.kdragon.bluestone.sql.BotAdmin;
import com.kdragon.bluestone.sql.GuildPrefix;
...
public class AdminCog extends Cog {
    ...
    private void adminCmdAdd(Context ctx) throws SQLException, PermissionError {
        com.kdragon.bluestone.Command.checkPerms(ctx, ADMIN_PERM);
    ...
    public void cmdPrefix(Context ctx) throws SQLException, PermissionError {
        if (!ctx.args.empty) {
            com.kdragon.bluestone.Command.checkPerms(ctx, PREFIX_MOD_PERMS);
