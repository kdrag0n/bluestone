...
public class CogmanCog extends Cog {
    ...
    private static final String DEFAULT_COGS_PATH = "com.kdragon.bluestone.cogs";
    ...
    private static final String NO_COMMAND = "🤔 **I need an action!**\n" +
            ...
            "    \u2022 `list {package path}` - list cogs available (default path `com.kdragon.bluestone.cogs`)\n" +
            ...
            "or simple name (assumed to be in `com.kdragon.bluestone.cogs`).";
