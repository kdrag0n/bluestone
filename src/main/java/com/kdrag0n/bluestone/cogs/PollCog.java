...
public class PollCog extends com.kdrag0n.bluestone.Cog {
    ...
    public PollCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "poll", desc = "Start a reaction poll.", usage = "[emotes] [question] [time]", guildOnly = true)
    public void cmdPoll(com.kdrag0n.bluestone.Context ctx) {
        ...
        Set<String> unicodeEmotes = com.kdrag0n.bluestone.util.RegexUtils.matchStream(UNICODE_EMOTE_PATTERN, preQuestion)
                .map(MatchResult::group).collect(Collectors.toSet());
        Set<Emote> customEmotes = com.kdrag0n.bluestone.util.RegexUtils.matchStream(CUSTOM_EMOTE_PATTERN, preQuestion)
        ...
        preQuestion = _m.usePattern(com.kdrag0n.bluestone.emotes.DiscordEmoteProvider.CUSTOM_EMOTE_PATTERN).reset(preQuestion).replaceAll("");
        ...
        ctx.send(embed.build()).queue(msg -> {
            ...
            com.kdrag0n.bluestone.Bot.threadExecutor.execute(() -> {
                try {
                    pollDao.create(poll);
                } catch (SQLException e) {
            ...
            com.kdrag0n.bluestone.Bot.scheduledExecutor.schedule(() ->
