...
public class NotesCog extends com.kdrag0n.bluestone.Cog {
    ...
    public NotesCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    }
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "notes", desc = "Manage notes in this server.", aliases = {"note", "n"})
    public void mainCmd(com.kdrag0n.bluestone.Context ctx) throws com.kdrag0n.bluestone.errors.PermissionError {
