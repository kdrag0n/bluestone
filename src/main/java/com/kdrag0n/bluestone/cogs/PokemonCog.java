...
public class PokemonCog extends com.kdrag0n.bluestone.Cog {
    ...
    public PokemonCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "pokémon", desc = "Get info about a Pokémon!", thread = true,
            aliases = {"pokemon", "pokèmon", "pokedex", "pokédex"}, usage = "{name or id}")
    public void command(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        ...
        EmbedBuilder emb = new EmbedBuilder()
                ...
                .addField("HP", Strings.str(pokemon.hp), true)
                .addField("Stats", stats, true)
                .addField("Special Stats", specialStats, true)
                .addField("Speed", Strings.str(pokemon.speed), true)
