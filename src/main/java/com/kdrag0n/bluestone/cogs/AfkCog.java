...
public class AfkCog extends com.kdrag0n.bluestone.Cog {
    ...
    public AfkCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    public void onMsg(GuildMessageReceivedEvent event) throws SQLException {
        ...
        if (event.getMessage().getMentionedUsers().size() != 0) {
            ...
            if (added.size() != 0) {
                event.getChannel().sendMessage(com.kdrag0n.bluestone.Context.filterMessage(message.toString())).queue();
            }
        }
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "afk",
    ...
    public void cmdAfk(com.kdrag0n.bluestone.Context ctx) throws SQLException {
