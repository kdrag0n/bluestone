...
public class GoogleCog extends com.kdrag0n.bluestone.Cog {
    ...
    public GoogleCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    }
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "google", desc = "We all need Google.", usage = "[search terms]", aliases = {"search"}, thread = true)
    public void cmdGoogle(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
