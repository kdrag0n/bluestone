...
public class ReplCog extends com.kdrag0n.bluestone.Cog {
    ...
    public ReplCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "repl", desc = "A multilingual REPL, in Discord!\n\nFlags come before language in arguments.",
            usage = "[language] {flags}", thread=true)
    public void cmdRepl(com.kdrag0n.bluestone.Context ctx) {
        ...
        if (replSessions.contains(ctx.channel.getIdLong())) {
            ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + "REPL is already active in this channel.").queue();
            return;
        }
        ...
        try {
            new com.kdrag0n.bluestone.util.Switch<Class<? extends ScriptEngine>>(engine.getClass())
                    .byInstance()
            ...
            ctx.send("⚠ Engine post-init failed.\n```java\n" + com.kdrag0n.bluestone.util.StackUtil.renderStackTrace(e) + "```").queue();
        }
        ...
        while (true) {
            ...
            try {
                ...
                result = com.kdrag0n.bluestone.util.StackUtil.renderStackTrace(e);
            }
            ...
            if (result != null) {
                try {
                    ...
                    try {
                        ctx.send("```java\n" +
                                StringUtils.replace(com.kdrag0n.bluestone.util.StackUtil.renderStackTrace(e), token, "") + "```").queue();
                    } catch (Exception ex) {
    ...
    private Message waitForRMessage(long millis, Predicate<Message> check,
        ...
        com.kdrag0n.bluestone.handlers.RMessageWaitListener listener = new com.kdrag0n.bluestone.handlers.RMessageWaitListener(lock, check, rCheck, channelId);
