...
public class StarboardCog extends com.kdrag0n.bluestone.Cog {
    ...
    public StarboardCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    private Color starGradientColor(int stars) {
        ...
        return com.kdrag0n.bluestone.util.GraphicsUtils.interpolateColors(new Color(0xfffdf7), new Color(0xffc20c), percent);
    }
            ...
            if (origMessage.getEmbeds().size() > 0) {
                ...
                if (data.getType() == EmbedType.IMAGE) {
                    ...
                    for (MessageEmbed embed : origMessage.getEmbeds()) {
                        String value = NullValueWrapper.val(data.getTitle()).or("*No title*");
    ...
    private Starboard requireStarboard(com.kdrag0n.bluestone.Context ctx) throws com.kdrag0n.bluestone.errors.PassException, SQLException {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "star", desc = "Master starboard management command.", aliases = {"stars", "starboard", "starman"},
            thread = true, guildOnly = true)
    public void managementCommand(com.kdrag0n.bluestone.Context ctx) throws Throwable {
        if (ctx.args.empty) {
    ...
    private void cmdCreate(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        com.kdrag0n.bluestone.Command.checkPerms(ctx, MOD_PERMS);

        Starboard oldBoard = dao.queryForId(ctx.guild.getIdLong());
        if (oldBoard != null) {
            ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " This server already has a starboard! <#" +
        ...
        if (ctx.args.length > 1) {
            ...
            if (!com.kdrag0n.bluestone.util.Strings.isChannelName(wantedName)) {
    ...
    private void cmdAge(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        com.kdrag0n.bluestone.Command.checkPerms(ctx, MOD_PERMS);
    ...
    private void cmdLock(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        com.kdrag0n.bluestone.Command.checkPerms(ctx, MOD_PERMS);
    ...
    private void cmdUnlock(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        com.kdrag0n.bluestone.Command.checkPerms(ctx, MOD_PERMS);
    ...
    private void cmdThreshold(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        com.kdrag0n.bluestone.Command.checkPerms(ctx, MOD_PERMS);
    ...
    private void cmdClean(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        Starboard starboard = requireStarboard(ctx);
        if (ctx.args.length < 2) {
    ...
    private void cmdRandom(com.kdrag0n.bluestone.Context ctx) throws Throwable {
        Starboard starboard = requireStarboard(ctx);
    ...
    private void cmdShow(com.kdrag0n.bluestone.Context ctx) throws SQLException, ExecutionException {
        Starboard starboard = requireStarboard(ctx);
    ...
    private void cmdStats(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        Starboard starboard = requireStarboard(ctx);
        ...
        EmbedBuilder emb = new EmbedBuilder()
                .setColor(NullValueWrapper.val(ctx.member.getColor()).or(Color.WHITE))
