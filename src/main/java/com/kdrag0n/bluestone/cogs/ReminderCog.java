...
public class ReminderCog extends com.kdrag0n.bluestone.Cog {
    ...
    public ReminderCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "remindme", desc = "Schedule a reminder for you at a certain time, over DM.",
            usage = "[time/date] [message", aliases = {"remind", "remind_me"})
    public void cmdRemindMe(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        ...
        ctx.send(com.kdrag0n.bluestone.Emotes.getSuccess() + " I will remind you at " + date + '.').queue();
    }
}
