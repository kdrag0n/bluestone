...
import com.kdrag0n.bluestone.emotes.EmoteInfo;
...
public class FunCog extends com.kdrag0n.bluestone.Cog {
    private static final Logger logger = LogManager.getLogger(FunCog.class);
    private static final Map<String, com.kdrag0n.bluestone.util.UnisafeString> charsets = new HashMap<String, com.kdrag0n.bluestone.util.UnisafeString>() {{
        ...
        put("why_not", uniString("å∫ç∂´ƒ©˙ˆ∆˚¬µ˜øπœ®ß†¨√∑≈¥ΩÅıÇÎÉÏöÓÎ╲⎝╱ÂõØ∏∑çÍìÜêÂ⧸Ú⎠º¡™£¢∞§¶•ª `⁄€‹›ﬁﬂ‡°·‚–⧹≠±“‘”’»…ÚæÆ≤¯≥˘ÚæÆ?"));
    }};
    ...
    private static final MessageEmbed BLEACH_EMBED = new EmbedBuilder()
            ...
            .build();
    private final com.kdrag0n.bluestone.emotes.EmoteProviderManager emoteProviderManager = new com.kdrag0n.bluestone.emotes.EmoteProviderManager();

    private static com.kdrag0n.bluestone.util.UnisafeString uniString(String javaString) {
        return new com.kdrag0n.bluestone.util.UnisafeString(javaString);
    }
    private static<L, R> ImmutablePair<L, R> pair(L l, R r) {
        return ImmutablePair.of(l, r);
    }

    public FunCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);

        OkHttpClient http = new OkHttpClient();
        emoteProviderManager.addProvider(new com.kdrag0n.bluestone.emotes.TwitchEmoteProvider(http));
        emoteProviderManager.addProvider(new com.kdrag0n.bluestone.emotes.BetterTTVEmoteProvider(http));
        emoteProviderManager.addProvider(new com.kdrag0n.bluestone.emotes.FrankerFaceZEmoteProvider(http));
        emoteProviderManager.addProvider(new com.kdrag0n.bluestone.emotes.DiscordEmoteProvider());
    }
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "reverse", desc = "Reverse some text.", usage = "[text]")
    public void cmdReverse(com.kdrag0n.bluestone.Context ctx) {
        ctx.send(":repeat: " + StringUtils.reverse(ctx.rawArgs)).queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "emotisay", desc = "Show some text as cool block letters.", aliases = {"emotesay", "esay"}, usage = "[text]")
    public void cmdEmotisay(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.fail("You need some text!");
            return;
        }

        ctx.send(com.kdrag0n.bluestone.util.Strings.simpleJoin(ctx.rawArgs.chars().mapToObj(c -> {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "cookie", desc = "Cookie time!")
    public void cmdCookie(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("\uD83C\uDF6A").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "triggered", desc = "TRIGGERED")
    public void cmdTriggered(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("***TRIGGERED***").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "lenny", desc = "Le Lenny Face.")
    public void cmdLenny(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("( ͡° ͜ʖ ͡°)").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "tableflip", desc = "Flip that table!")
    public void cmdTableflip(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("(╯°□°）╯︵ ┻━┻").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "unflip", desc = "Flip that table back up!")
    public void cmdUnflip(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("┬─┬\uFEFF ノ( ゜-゜ノ)").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "hyflip", desc = "Is that table flipped or not? Oh wait, it's broken...")
    public void cmdHyflip(com.kdrag0n.bluestone.Context ctx) {
        ctx.send("(╯°□°）╯︵ ┻━─┬\uFEFF ノ( ゜-゜ノ)").queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "bleach", desc = "Get me some bleach. NOW.")
    public void cmdBleach(com.kdrag0n.bluestone.Context ctx) {
        ctx.send(BLEACH_EMBED).queue();
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "cat", desc = "Get a random cat!", thread = true, aliases = {"randcat"})
    public void cmdCat(com.kdrag0n.bluestone.Context ctx) {
        ctx.channel.sendTyping().queue();

        try {
            String cat = new JSONObject(com.kdrag0n.bluestone.Bot.http.newCall(new Request.Builder()
                    .get()
                    .url("https://random.cat/meow")
                    .build()).execute().body().string()).optString("file", null);
            String fact = new JSONObject(com.kdrag0n.bluestone.Bot.http.newCall(new Request.Builder()
                    .get()
            ...
            if (ctx.guild == null)
                ...
                color = NullValueWrapper.val(ctx.member.getColor()).or(Color.WHITE);
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "dog", desc = "Get a random dog!", thread = true, aliases = {"randdog"})
    public void cmdDog(com.kdrag0n.bluestone.Context ctx) {
        ctx.channel.sendTyping().queue();
        ...
        try {
            ...
            String fact = NullValueWrapper.val(new JSONObject(com.kdrag0n.bluestone.Bot.http.newCall(new Request.Builder()
                    .get()
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "emote", desc = "Get an emoticon, from many sources.", usage = "[emote name]")
    public void cmdEmote(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
        ...
        }, e -> ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " Failed to fetch emote.").queue()));
    }

    @com.kdrag0n.bluestone.Perm.ManageEmotes
    @com.kdrag0n.bluestone.annotations.Command(name = "add_emote", desc = "Add an emote to the server.", usage = "[emote name]",
            aliases = {"addemote", "emoteadd", "emote_add", "+emote", "+e"}, guildOnly = true)
    public void cmdAddEmote(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.fail("You need to specify an emote! Twitch, Discord (custom only), FrankerFaceZ, and BetterTTV are supported.");
            return;
        ...
        com.kdrag0n.bluestone.Bot.http.newCall(new Request.Builder()
            ...
            ctx.send(com.kdrag0n.bluestone.Emotes.getSuccess() + " Emote added. " + emote.getAsMention()).queue();
        }, e -> ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " Failed to fetch or create emote.").queue()));
    }

    private String applyStyle(String orig, com.kdrag0n.bluestone.util.UnisafeString mapTo) {
        com.kdrag0n.bluestone.util.UnisafeString mapFrom = charsets.get("normal");
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "styles", desc = "List the available text styles.", aliases = {"fonts"})
    public void cmdStyles(com.kdrag0n.bluestone.Context ctx) {
        ...
        for (Map.Entry<String, com.kdrag0n.bluestone.util.UnisafeString> entry: charsets.entrySet()) {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "style", desc = "Apply a style to some text.", aliases = {"font"})
    public void cmdStyle(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " Usage is `style [style name] [text]`.\n" +
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "lmgtfy", desc = "Let me Google that for you!")
    public void cmdLmgtfy(com.kdrag0n.bluestone.Context ctx) throws UnsupportedEncodingException {
        if (ctx.args.empty) {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "slap", desc = "Slap someone, with passion.", aliases = {"boop", "poke", "hit"})
    public void cmdSlap(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "meme", desc = "Generate a custom meme.", usage = "[meme text / [top text] | [bottom text]]")
    public void cmdMeme(com.kdrag0n.bluestone.Context ctx) {
        ...
        com.kdrag0n.bluestone.Bot.http.newCall(new Request.Builder()
            ...
            if (resp.optBoolean("success", false)) {
                ...
                ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " Error: `" + resp.getString("error_message") + '`').queue();
            }
        }, e -> {
            logger.error("Imgflip request errored", e);
            ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() + " Request failed. `" + e.getMessage() + '`').queue();
        }));
    }

    @com.kdrag0n.bluestone.annotations.Command(name = "attack", desc = "Hurt someone, with determination.", aliases = {"stab", "kill", "punch", "shoot", "hurt", "fight"})
    public void cmdAttack(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.fail("I need someone to " + ctx.invoker + '!');
            return;
        }
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "soon", desc = "Feel the loading of 10000 years, aka Soon™.", aliases = {"soontm"})
