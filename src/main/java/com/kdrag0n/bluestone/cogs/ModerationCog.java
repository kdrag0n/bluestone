...
public class ModerationCog extends com.kdrag0n.bluestone.Cog {
    private static final Logger logger = LogManager.getLogger(ModerationCog.class);
    private static final String PURGE_NO_PARAMS = com.kdrag0n.bluestone.Emotes.getFailure() + " **No valid parameters included!**\n" +
            "Valid parameters:\n" +
    ...
    public ModerationCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    ...
    public void onMemberJoin(GuildMemberJoinEvent event) throws SQLException {
        ...
        for (GuildAutorole autorole: autoroles) {
            ...
            if (com.kdrag0n.bluestone.enums.AutoroleConditions.test(autorole.getConditions()))
                toAdd.add(role);
        }
    ...
    @com.kdrag0n.bluestone.Perm.Combo.ManageMessagesAndReadHistory
    @com.kdrag0n.bluestone.annotations.Command(name = "purge", desc = "Purge messages from a channel.", guildOnly = true,
            aliases = {"clean", "nuke", "prune", "clear"},
            usage = "[parameters]", thread = true)
    public void cmdPurge(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
        ...
        ctx.send(com.kdrag0n.bluestone.Emotes.getSuccess() + " Deleted **" + toDelete.size() +
                "** message" + k + '!' + twoWeekWarn).queue(
                        msg -> msg.delete().queueAfter(2, TimeUnit.SECONDS, null, exp -> {}));
    }

    @com.kdrag0n.bluestone.Perm.ManageRoles
    @com.kdrag0n.bluestone.Perm.ManageChannels
    @com.kdrag0n.bluestone.Perm.ManagePermissions
    @com.kdrag0n.bluestone.annotations.Command(name = "mute", desc = "Mute someone in all text channels.", guildOnly = true,
            usage = "[@user] {reason}")
    public void cmdMute(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.fail("I need someone to mute!");
            return;
        } else if (!com.kdrag0n.bluestone.util.Strings.isMention(ctx.rawArgs) || ctx.message.getMentionedUsers().size() < 1) {
        ...
        ctx.send(":hourglass: Muting...").queue(status -> {
            ...
            status.editMessage(com.kdrag0n.bluestone.Emotes.getSuccess() + " Muted **" +
    ...
    @com.kdrag0n.bluestone.Perm.ManageRoles
    @com.kdrag0n.bluestone.Perm.ManageChannels
    @com.kdrag0n.bluestone.annotations.Command(name = "unmute", desc = "Unmute someone in all text channels.", guildOnly = true, usage = "[@user] {reason}")
    public void cmdUnmute(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
        ...
        ctx.send(":hourglass: Unmuting...").queue(status -> {
            ...
            status.editMessage(com.kdrag0n.bluestone.Emotes.getSuccess() + " Unmuted **" +
                    user.getUser().getName() +
                    '#' +
                    user.getUser().getDiscriminator() +
                    "**.").queue();
    ...
    @com.kdrag0n.bluestone.Perm.Ban
    @com.kdrag0n.bluestone.annotations.Command(name = "ban", desc = "Swing the ban hammer on someone.", guildOnly = true,
            usage = "[@user or user ID] {reason}")
    public void cmdBan(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
            ctx.fail("I need someone to ban!");
            return;
        } else if ((!MENTION_PATTERN.matcher(ctx.rawArgs).find() || ctx.message.getMentionedUsers().size() < 1) &&
                !com.kdrag0n.bluestone.util.Strings.isID(ctx.args.get(0))) {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "kick", desc = "Kick a member of the server.", guildOnly = true,
            usage = "[@user or user ID] [reason]")
    public void cmdKick(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.args.empty) {
    ...
    @com.kdrag0n.bluestone.Perm.ManageRoles
    @com.kdrag0n.bluestone.annotations.Command(name = "autorole", desc = "Manage autoroles in this server.", guildOnly = true,
            usage = "[action] {role}", aliases = {"autoroles", "ar"}, thread = true)
    public void cmdAutorole(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        if (ctx.args.empty) {
    ...
    private Role parseRole(Guild guild, String roleArg) {
        ...
        if (com.kdrag0n.bluestone.util.Strings.isRoleMention(roleArg)) {
            return guild.getRoleById(roleArg.substring(3, roleArg.length() - 1));
        } else if (com.kdrag0n.bluestone.util.Strings.isID(roleArg)) {
    ...
    private Role requireRole(com.kdrag0n.bluestone.Context ctx) {
        Role role;
    ...
    private void autoroleList(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        ...
        EmbedBuilder emb = new EmbedBuilder()
                ...
                .setColor(NullValueWrapper.val(ctx.guild.getSelfMember().getColor()).or(Color.WHITE))
    ...
    private void autoroleAdd(com.kdrag0n.bluestone.Context ctx) throws SQLException {
    ...
    private void autoroleRemove(com.kdrag0n.bluestone.Context ctx) throws SQLException {
        Role role = requireRole(ctx);
        if (!autoroleDao.idExists(role.getIdLong())) {
    ...
    private void autoroleClear(com.kdrag0n.bluestone.Context ctx) throws SQLException {
    ...
    @com.kdrag0n.bluestone.Perm.Invite
    @com.kdrag0n.bluestone.annotations.Command(name = "instant_invite", desc = "Create an instant invite that never expires.",
    ...
    public void cmdMakeInvite(com.kdrag0n.bluestone.Context ctx) {
