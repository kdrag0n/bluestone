...
public class GameCog extends com.kdrag0n.bluestone.Cog {
    private static final Logger logger = LogManager.getLogger(GameCog.class);

    public GameCog(com.kdrag0n.bluestone.Bot bot) {
        super(bot);
    }
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "rps", desc = "Play a game of Rock, Paper, Scissors with the bot. (10 rounds)")
    public void cmdRps(com.kdrag0n.bluestone.Context ctx) {
    ...
    private final class RpsGame {
        ...
        private RpsGame(com.kdrag0n.bluestone.Context ctx) {
            ...
            if (ctx.guild == null)
                ...
                emb.setColor(NullValueWrapper.val(ctx.member.getColor()).or(Color.WHITE));
        ...
        private void scheduleEventWait(com.kdrag0n.bluestone.Context ctx) {
    ...
    @com.kdrag0n.bluestone.annotations.Command(name = "akinator", desc = "Play a game of Akinator, where you answer questions for it to guess your character.",
            aliases = {"guess"})
    public void cmdAkinator(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.channel instanceof TextChannel &&
                !ctx.member.hasPermission((Channel) ctx.channel,
                        Permission.MESSAGE_ADD_REACTION, Permission.MESSAGE_EMBED_LINKS)) {
            ctx.send(com.kdrag0n.bluestone.Emotes.getFailure() +
    ...
    private final class AkinatorGame {
        ...
        private AkinatorGame(com.kdrag0n.bluestone.Context ctx) throws IOException, JSONException {
            this.channel = ctx.channel;
            this.userId = ctx.author.getIdLong();
        ...
        private void answerQuestion(byte answer) {
            try {
                JSONObject json = new JSONObject(client.newCall(new Request.Builder()
                        .get()
                        .url(com.kdrag0n.bluestone.util.Strings.buildQueryUrl(ANSWER_URL,
                                "session", session,
                                "signature", signature,
                                "step", com.kdrag0n.bluestone.util.Strings.str(stepInfo.getStepNum()),
            ...
            try {
                if (answer == 0) {
                    client.newCall(new Request.Builder()
                            .get()
                            .url(com.kdrag0n.bluestone.util.Strings.buildQueryUrl(CHOICE_URL,
                                    "session", session,
                                    "signature", signature,
                                    "step", com.kdrag0n.bluestone.util.Strings.str(stepInfo.getStepNum()),
                                    "element", guess.getId()))
                    ...
                    client.newCall(new Request.Builder()
                            .get()
                            .url(com.kdrag0n.bluestone.util.Strings.buildQueryUrl(EXCLUSION_URL,
                                    "session", session,
                                    "signature", signature,
                                    "step", com.kdrag0n.bluestone.util.Strings.str(stepInfo.getStepNum()),
        ...
        private class Guess {
            ...
            Guess() throws IOException {
                JSONObject json = new JSONObject(client.newCall(new Request.Builder()
                        .get()
                        .url(com.kdrag0n.bluestone.util.Strings.buildQueryUrl(GET_GUESS_URL,
                                "session", session,
                                "signature", signature,
                                "step", com.kdrag0n.bluestone.util.Strings.str(stepInfo.getStepNum())))
                        .build()).execute().body().string());
