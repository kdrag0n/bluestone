...
public class Strings {
    ...
    public static String replace(String input, Pattern regex, com.kdrag0n.bluestone.util.StringReplacerCallback callback) {
    ...
    public static com.kdrag0n.bluestone.util.StringMapper createMap() {
        return com.kdrag0n.bluestone.util.StringMapper.match();
    }
