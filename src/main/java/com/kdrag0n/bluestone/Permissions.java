...
public class Permissions {
    ...
    public static boolean check(com.kdrag0n.bluestone.Context ctx, Permission... permsAccepted) {
        if (ctx.author.getIdLong() == com.kdrag0n.bluestone.Bot.ownerId)
            return true;
        ...
        for (Permission perm: permsAccepted) {
            if (perm == BOT_ADMIN) {
                ...
                if (com.kdrag0n.bluestone.Bot.patronIds.contains(ctx.author.getIdLong()))
                    return true;
