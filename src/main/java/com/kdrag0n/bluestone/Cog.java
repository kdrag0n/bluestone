...
public abstract class Cog {
    protected final com.kdrag0n.bluestone.Bot bot;
    public abstract String getName();
    public abstract String getDescription();

    public Cog(com.kdrag0n.bluestone.Bot bot) {
        this.bot = bot;
    }
    ...
    protected static EmbedBuilder newEmbedWithAuthor(com.kdrag0n.bluestone.Context ctx) {
        String name;
        String iconUrl;
    ...
    protected static EmbedBuilder newEmbedWithAuthor(com.kdrag0n.bluestone.Context ctx, String url) {
        String name;
        String iconUrl;
    ...
    protected static String getEffectiveName(com.kdrag0n.bluestone.Context ctx) {
        if (ctx.guild == null) {
