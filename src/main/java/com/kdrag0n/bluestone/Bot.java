...
import com.kdrag0n.bluestone.util.RandomSelect;
...
public class Bot implements EventListener, com.kdrag0n.bluestone.util.ClassUtilities {
    ...
    private void onMessageReceived(MessageReceivedEvent event) {
        ...
        if (content.startsWith(prefix)) {
            ...
            final com.kdrag0n.bluestone.util.ArrayListView args = new com.kdrag0n.bluestone.util.ArrayListView(split);
            ...
            final String request = com.kdrag0n.bluestone.util.Strings.renderMessage(message, message.getGuild(),
            ...
            final String request = com.kdrag0n.bluestone.util.Strings.renderMessage(message, null, message.getContentRaw());
    ...
    private MessageEmbed errorEmbed(Throwable e, Message msg, Command cmd) {
        String stack = com.kdrag0n.bluestone.util.StackUtil.renderStackTrace(e, "\u3000", "> ");
        ...
        if (e.getCause() != null) {
            String causeStack = com.kdrag0n.bluestone.util.StackUtil.renderStackTrace(e, "\u3000", "> ");
    ...
    public String formatUptime() {
        return com.kdrag0n.bluestone.util.Strings.formatDuration((new Date().getTime() - shardUtil.startTime.getTime()) / 1000L);
    }
