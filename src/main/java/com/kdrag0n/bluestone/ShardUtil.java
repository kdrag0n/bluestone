...
public class ShardUtil {
    ...
    private final Map<Integer, com.kdrag0n.bluestone.Bot> shards = new LinkedHashMap<>();
    ...
    public com.kdrag0n.bluestone.Bot getShard(int shardId) {
        return shards.get(shardId);
    }

    public void setShard(int shardId, com.kdrag0n.bluestone.Bot bot) {
        shards.put(shardId, bot);
    }

    public Collection<com.kdrag0n.bluestone.Bot> getShards() {
    ...
    private int sumBot(ObjectFunctionInt<com.kdrag0n.bluestone.Bot> fn) {
        int total = 0;

        for (com.kdrag0n.bluestone.Bot shard: shards.values()) {
