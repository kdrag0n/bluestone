...
public class BetterTTVEmoteProvider implements com.kdrag0n.bluestone.emotes.EmoteProvider {
    ...
    @Override
    public com.kdrag0n.bluestone.emotes.EmoteInfo getEmoteInfo(String emote) {
        if (emotes.has(emote)) {
            JSONObject emoteObj = emotes.getJSONObject(emote);
            return new com.kdrag0n.bluestone.emotes.EmoteInfo(emote, emoteObj.getString("id"), null);
        } else {
            return null;
        }
    }
